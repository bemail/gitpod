...
func TestListWorkspacesByID(t *testing.T) {
	...
	workspaces := []db.Workspace{
		dbtest.NewWorkspace(t, db.Workspace{ID: "gitpodio-gitpod-aaaaaaaaaaa", Type: db.WorkspaceType_Prebuild}),
		dbtest.NewWorkspace(t, db.Workspace{ID: "gitpodio-gitpod-bbbbbbbbbbb", Type: db.WorkspaceType_Regular}),
	}
