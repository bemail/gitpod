...
type ControlServiceClient interface {
	...
	VerifyKeyPair(ctx context.Context, in *VerifyPublicKeyRequest, opts ...grpc.CallOption) (*VerifyPublicKeyResponse, error)
}
...
func (c *controlServiceClient) VerifyKeyPair(ctx context.Context, in *VerifyPublicKeyRequest, opts ...grpc.CallOption) (*VerifyPublicKeyResponse, error) {
	out := new(VerifyPublicKeyResponse)
	err := c.cc.Invoke(ctx, "/supervisor.ControlService/VerifyKeyPair", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControlServiceServer interface {
	...
	// VerifyKeyPair Send the public to supervisor then check with ~/.ssh/authorized_keys
	VerifyKeyPair(context.Context, *VerifyPublicKeyRequest) (*VerifyPublicKeyResponse, error)
...
func (UnimplementedControlServiceServer) VerifyKeyPair(context.Context, *VerifyPublicKeyRequest) (*VerifyPublicKeyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VerifyKeyPair not implemented")
}
...
func _ControlService_VerifyKeyPair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyPublicKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControlServiceServer).VerifyKeyPair(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supervisor.ControlService/VerifyKeyPair",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControlServiceServer).VerifyKeyPair(ctx, req.(*VerifyPublicKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ControlService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VerifyKeyPair",
			Handler:    _ControlService_VerifyKeyPair_Handler,
		},
	},
